...
//        mLocationRequest.setInterval(SyncStateContract.Constants.LOCATION_INTERVAL);
//        mLocationRequest.setFastestInterval(SyncStateContract.Constants.FASTEST_LOCATION_INTERVAL);
