...
public class SpinnerRetailerAdapter extends ArrayAdapter<MyPojo> {

    LayoutInflater flater;

    public SpinnerRetailerAdapter(Activity context, int resouceId, int textviewId, List<MyPojo> list){
