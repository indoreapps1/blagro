...
public class SpinnerDistributorAdapter extends ArrayAdapter<MyPojo> {

    LayoutInflater flater;

    public SpinnerDistributorAdapter(Activity context, int resouceId, int textviewId, List<MyPojo> list){
