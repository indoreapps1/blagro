                        ...
                        if (!workName.trim().equalsIgnoreCase("no")) {
                            ...
                            if (myPojos != null) {
                                ...
                                if (areaPojoList != null && areaPojoList.size() > 0) {
                                    AreaAdapter arrayAdapter = new AreaAdapter(DistributorActivity.this, android.R.layout.simple_dropdown_item_1line, R.id.item_txt, areaPojoList);
                                    spinner_area.setAdapter(arrayAdapter);
                                }
                            } else {
                                Toast.makeText(DistributorActivity.this, "No Area Found", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(DistributorActivity.this, "No Area Found", Toast.LENGTH_SHORT).show();
                        }
...
//                    Toast.makeText(RetailerListActivity.this, workName, Toast.LENGTH_SHORT).show();
    ...
    private void setAdapter() {
        distributorAdapter = new DistributorAdapter(DistributorActivity.this, distributorPojoList, true);
